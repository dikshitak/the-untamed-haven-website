    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      ...
      <div className="col-span-2 aspect-square relative">
        <Image
          ...
          alt="Family that manages The Untamed Haven"
        />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Untamed Haven has been a cherished family-run
          ...
          <p>
            Over the years, we&apos;ve maintained the essence of The Untamed
            Haven, blending the timeless beauty of the mountains with the
            personal touch only a family business can offer. Here, you&apos;re
            not just a guest; you&apos;re part of our extended family. So join
            us at The Untamed Haven soon, where tradition meets tranquility, and
